...
<tileset version="1.10" tiledversion="1.11.2" name="SpriteSheet_Attorney_Infected" tilewidth="32" tileheight="64" tilecount="64" columns="16">
 <image source="SpriteSheet_Attorney_Infected.png" width="512" height="256"/>
 <tile id="0">
  <animation>
