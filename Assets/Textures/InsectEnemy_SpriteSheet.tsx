...
<tileset version="1.10" tiledversion="1.11.2" name="SpriteSheet_InsectEnemy" tilewidth="80" tileheight="80" tilecount="24" columns="4">
 <image source="SpriteSheet_InsectEnemy.png" width="320" height="480"/>
 <tile id="0">
  <animation>
