...
<tileset version="1.10" tiledversion="1.11.2" name="SpriteSheet_LongEnemy" tilewidth="32" tileheight="80" tilecount="24" columns="4">
 <image source="SpriteSheet_LongEnemy.png" width="128" height="480"/>
 <tile id="0">
  <animation>
