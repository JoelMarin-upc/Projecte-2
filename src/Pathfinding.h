...
public:
    ...
    Vector2D ComputePath(int x, int y);
...
public:
    ...
    int blockedGid = 2824; //Gid of the tiles that block the path - Important adjust this value to your map
    int highCostGid = 30; //Gid of the tiles that have high cost - Important adjust this value to your map
    bool debug;
